...
#-0.24512  0.08755  0.24038  0.22966  0.38227  0.64071 
...
#IN THE CASE WHEN USING OBSERVED DISTRIBUTIONS:
# The only significant differences appear for "true" thetas of 0.2043888; 0.149363
...
#Significant difference only for ability:0.1388557 (student 13)
...
#----------------------------------------------------------------------------------------------------
t.test(students_abilities_L[[40]]$diff, students_abilities_L[[27]]$diff)
...
#---------------------------------------------------------------------------------------------------
t.test(students_abilities_L[[1]]$diff, students_abilities_L[[10]]$diff)
...
t.test(students_abilities_R[[40]]$diff, students_abilities_R[[27]]$diff)
...
#---------------------------------------------------------------------------------------------------
t.test(students_abilities_R[[1]]$diff, students_abilities_R[[10]]$diff)
#no differnece
...
t.test(students_abilities_T[[40]]$diff, students_abilities_T[[27]]$diff)
