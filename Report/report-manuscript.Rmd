...
First, an initial exploration of the data prepared for the analysis is given, and the assumptions of the analysis are briefly discussed, finally the results are presented and discussed.
...
```{r echo=FALSE}
levenes.test <- leveneTest(avg.theta.diff ~ subject, data)
kable(levenes.test)
```
